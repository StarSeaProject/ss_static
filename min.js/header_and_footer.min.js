$("body").addClass("container-fluid");let avatarurl,strlogin="",defaultstr=`<a href="/login" class="anav">登录</a>`;"undefined"==typeof user?strlogin=defaultstr:user?(avatarurl=user.avatar,strlogin=`<div id="loginbox">
            ...
            </div>`):strlogin=defaultstr,$("body").prepend(`
...
`),avatarurl&&$("#imgavatar").attr("src",avatarurl),$("#floatbox").hide(),$("#loginbox").hover(function(){$("#floatbox").slideToggle(200)},function(){$("#floatbox").slideToggle(200)});

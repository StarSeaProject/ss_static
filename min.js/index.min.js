$(function(){windowwidth=$(window).width(),console.log(windowwidth),1920>windowwidth&&$(window).scrollLeft((1920-windowwidth)/2);let a,b;user?(a=user.avatar,b=`
		<div id="usernav">
    ...
    `,a&&$("#imgavatar").attr("src",a),$("#navup").append(b)});

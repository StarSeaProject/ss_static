$("body").addClass("container-fluid");let strlogin="";strlogin=user?`<div id="loginbox">
...
</div>`:`<a href="/login" class="anav">登录</a>`,$("body").prepend(`
...
`),$("#floatbox").hide(),$("#loginbox").hover(function(){$("#floatbox").slideToggle(200)},function(){$("#floatbox").slideToggle(200)});

let avatarurl,strlogin='',defaultstr=`<div class="navbar-right col-xs-6 text-right container">
            <div class="row marow">
        ...
        </div>`;'undefined'==typeof user?strlogin=defaultstr:user?(avatarurl=user.avatar,strlogin=`<div class="navbar-right col-xs-4 text-right container">
            <div class="row marow">
...
`):strlogin=defaultstr,$('body').prepend(`<div class="container-fluid">
...
`),avatarurl&&$('#imgavatar').attr('src',avatarurl),$('#floatbox').hide(),$('#loginbox').click(function(a){$('#floatbox').slideDown(200),a.stopPropagation(),$(document).on('click',function(){$('#floatbox').slideUp(200)})});

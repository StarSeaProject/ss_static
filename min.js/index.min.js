$(function(){windowwidth=$(window).width(),console.log(windowwidth),1920>windowwidth&&$(window).scrollLeft((1920-windowwidth)/2);let a,b,c=`
    <div id="usernav">
    ...
    `;'undefined'==typeof user?b=c:user?(a=user.avatar,b=`
		<div id="usernav">
		...
		</div>`):b=c,a&&$('#imgavatar').attr('src',a),$('#navup').append(b)});
